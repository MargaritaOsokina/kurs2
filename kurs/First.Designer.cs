...
namespace kurs
{
    partial class First
    {
        ...
        private void InitializeComponent()
        {
            ...
            // button2
            // 
            this.button2.Location = new System.Drawing.Point(619, 322);
            ...
            this.label2.Text = "Реализовать точку-счетчик частиц, попадая в которую\r\n частица умирает, а на точке" +
    " пишется сколько частиц она уже собрала.";
            // 
            // label3
            // 
            ...
            this.label3.Text = "Реализовать точки перекрашивания частиц, попадая в радиус\r\n действия которой част" +
    "ицы меняют свой цвет на цвет указанный у точки.\r\n";
            // 
            // label4
            // 
